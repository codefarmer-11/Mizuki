...
export const ja: Translation = {
	...
	[Key.extensionToolBlankTitle]: "空白文字の生成とコピー",
	[Key.extensionToolBlankDesc]:
		"見えないUnicode文字を生成してワンクリックでコピー。空メッセージや空白表示名などに。複数の文字種と個数に対応。",
	[Key.extensionToolOpen]: "開く",
	[Key.extensionBlankWhatTitle]: "空白文字とは？",
	[Key.extensionBlankWhatDesc]:
		"空白文字（不可視文字）は画面上は空に見えますが、アプリは認識します。通常のスペースは除去されやすい一方、ゼロ幅スペースなどはフィルタを通過しやすく、チャットやゲーム名などに使われます。",
	[Key.extensionBlankGenerate]: "生成してコピー",
	[Key.extensionBlankKindLabel]: "文字の種類",
	[Key.extensionBlankCountLabel]: "個数",
	[Key.extensionBlankCopyButton]: "クリップボードにコピー",
	[Key.extensionBlankCopied]: "クリップボードにコピーしました",
	[Key.extensionBlankCopyFailed]: "コピーに失敗しました。下のテキストを手動で選択してください",
	[Key.extensionBlankManualTitle]: "手動コピー",
	[Key.extensionBlankManualDesc]:
		"ワンクリックでコピーできない場合は、下のボタンで選択して Ctrl+C（Mac: Cmd+C）でコピーしてください。",
	[Key.extensionBlankSelectButton]: "テキストを選択",
	[Key.extensionBlankSelected]: "選択済み — Ctrl+C / Cmd+C でコピー",
	[Key.extensionBlankTestTitle]: "貼り付けテスト",
	[Key.extensionBlankTestDesc]:
		"コピーした文字を下に貼り付けてください。文字数が増えればコピー成功です。",
	[Key.extensionBlankTestPlaceholder]: "ここに貼り付けてテスト…",
	[Key.extensionBlankCharCount]: "文字数",
	[Key.extensionBlankKind_zeroWidthSpace]: "ゼロ幅スペース (U+200B) — 最も一般的",
	[Key.extensionBlankKind_zeroWidthNonJoiner]: "ゼロ幅非接合子 (U+200C)",
	[Key.extensionBlankKind_zeroWidthJoiner]: "ゼロ幅接合子 (U+200D)",
	[Key.extensionBlankKind_wordJoiner]: "単語接合子 (U+2060)",
	[Key.extensionBlankKind_brailleBlank]: "点字空白 (U+2800)",
	[Key.extensionBlankKind_nobreakSpace]: "改行なしスペース (U+00A0)",
	[Key.extensionBlankKind_hangulFiller]: "ハングル充填子 (U+3164) — ゲーム名",
	[Key.extensionBlankKind_zeroWidthNoBreakSpace]: "ゼロ幅改行なしスペース (U+FEFF)",
	...
	[Key.comments]: "コメント",
	[Key.resources]: "リソース",
	[Key.resourcesSubtitle]: "もっと素敵なウェブサイトを見つける",
	[Key.resourcesSearchPlaceholder]: "名前または説明で検索...",
	[Key.resourcesFilterAll]: "すべて",
	[Key.resourcesNoResults]: "一致するリソースが見つかりません",
	[Key.resourcesVisit]: "訪問",
	[Key.resourcesCopyLink]: "リンク",
	[Key.resourcesCopySuccess]: "コピーしました",
	[Key.resourcesTags]: "タグ",
	[Key.untitled]: "無題",
