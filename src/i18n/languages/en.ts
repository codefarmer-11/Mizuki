...
export const en: Translation = {
	...
	[Key.extensionToolBlankTitle]: "Blank / invisible character",
	[Key.extensionToolBlankDesc]:
		"Generate and copy invisible Unicode characters for empty messages, blank display names, and more. Multiple character types and counts supported.",
	[Key.extensionToolOpen]: "Open",
	[Key.extensionBlankWhatTitle]: "What is an invisible character?",
	[Key.extensionBlankWhatDesc]:
		"Invisible characters look empty on screen but are recognized by apps. Regular spaces are often stripped; zero-width space and similar characters can pass filters—useful for chat apps, social profiles, and game names.",
	[Key.extensionBlankGenerate]: "Generate & copy",
	[Key.extensionBlankKindLabel]: "Character type",
	[Key.extensionBlankCountLabel]: "Count",
	[Key.extensionBlankCopyButton]: "Copy to clipboard",
	[Key.extensionBlankCopied]: "Copied to clipboard",
	[Key.extensionBlankCopyFailed]: "Copy failed—try selecting the text below manually",
	[Key.extensionBlankManualTitle]: "Manual copy",
	[Key.extensionBlankManualDesc]:
		"If one-click copy does not work, select the text below and press Ctrl+C (Cmd+C on Mac).",
	[Key.extensionBlankSelectButton]: "Select text",
	[Key.extensionBlankSelected]: "Selected—press Ctrl+C / Cmd+C to copy",
	[Key.extensionBlankTestTitle]: "Test paste",
	[Key.extensionBlankTestDesc]:
		"Paste your copied characters here. If the character count increases, the copy worked.",
	[Key.extensionBlankTestPlaceholder]: "Paste here to test…",
	[Key.extensionBlankCharCount]: "Character count",
	[Key.extensionBlankKind_zeroWidthSpace]: "Zero-width space (U+200B) — most common",
	[Key.extensionBlankKind_zeroWidthNonJoiner]: "Zero-width non-joiner (U+200C)",
	[Key.extensionBlankKind_zeroWidthJoiner]: "Zero-width joiner (U+200D)",
	[Key.extensionBlankKind_wordJoiner]: "Word joiner (U+2060)",
	[Key.extensionBlankKind_brailleBlank]: "Braille pattern blank (U+2800)",
	[Key.extensionBlankKind_nobreakSpace]: "No-break space (U+00A0)",
	[Key.extensionBlankKind_hangulFiller]: "Hangul filler (U+3164) — game names",
	[Key.extensionBlankKind_zeroWidthNoBreakSpace]: "Zero-width no-break space (U+FEFF)",
	...
	[Key.resourcesSubtitle]: "Discover more great websites",
	[Key.resourcesSearchPlaceholder]: "Search by title or description...",
	[Key.resourcesFilterAll]: "All",
	[Key.resourcesNoResults]: "No matching resources found",
	[Key.resourcesVisit]: "Visit",
	[Key.resourcesCopyLink]: "Copy Link",
	[Key.resourcesCopySuccess]: "Copied",
	[Key.resourcesTags]: "Tags",
