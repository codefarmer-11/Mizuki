...
export const zh_CN: Translation = {
	...
	[Key.extensionToolBlankTitle]: "空白字符生成与复制",
	[Key.extensionToolBlankDesc]:
		"生成并一键复制不可见字符，用于发送空白消息、空白昵称等场景；支持多种字符类型与数量。",
	[Key.extensionToolOpen]: "打开",
	[Key.extensionBlankWhatTitle]: "什么是空白字符？",
	[Key.extensionBlankWhatDesc]:
		"空白字符（不可见字符）在屏幕上看起来是空的，但能被软件识别。普通空格往往会被平台过滤，而零宽空格等字符可以绕过检测，用于 WhatsApp、Telegram、游戏昵称等场景。",
	[Key.extensionBlankGenerate]: "生成并复制",
	[Key.extensionBlankKindLabel]: "字符类型",
	[Key.extensionBlankCountLabel]: "数量",
	[Key.extensionBlankCopyButton]: "复制到剪贴板",
	[Key.extensionBlankCopied]: "已复制到剪贴板",
	[Key.extensionBlankCopyFailed]: "复制失败，请尝试手动选择下方文本",
	[Key.extensionBlankManualTitle]: "手动复制",
	[Key.extensionBlankManualDesc]:
		"若一键复制无效，可点击下方按钮选中字符，再按 Ctrl+C（Mac：Cmd+C）手动复制。",
	[Key.extensionBlankSelectButton]: "选择文本",
	[Key.extensionBlankSelected]: "已选中，请按 Ctrl+C / Cmd+C 复制",
	[Key.extensionBlankTestTitle]: "测试粘贴",
	[Key.extensionBlankTestDesc]:
		"将复制的字符粘贴到下方文本框。若字符计数增加，说明复制成功。",
	[Key.extensionBlankTestPlaceholder]: "在此粘贴以测试…",
	[Key.extensionBlankCharCount]: "字符计数",
	[Key.extensionBlankKind_zeroWidthSpace]: "零宽空格 (U+200B) — 最常用",
	[Key.extensionBlankKind_zeroWidthNonJoiner]: "零宽非连接符 (U+200C)",
	[Key.extensionBlankKind_zeroWidthJoiner]: "零宽连接符 (U+200D)",
	[Key.extensionBlankKind_wordJoiner]: "词连接符 (U+2060)",
	[Key.extensionBlankKind_brailleBlank]: "盲文空白 (U+2800)",
	[Key.extensionBlankKind_nobreakSpace]: "不间断空格 (U+00A0)",
	[Key.extensionBlankKind_hangulFiller]: "韩文填充符 (U+3164) — 游戏昵称",
	[Key.extensionBlankKind_zeroWidthNoBreakSpace]: "零宽不换行空格 (U+FEFF)",
	...
	[Key.comments]: "评论",
	[Key.resources]: "资源",
	[Key.resourcesSubtitle]: "发现更多优质网站",
	[Key.resourcesSearchPlaceholder]: "搜索资源名称或描述...",
	[Key.resourcesFilterAll]: "全部",
	[Key.resourcesNoResults]: "未找到匹配的资源",
	[Key.resourcesVisit]: "访问",
	[Key.resourcesCopyLink]: "复制链接",
	[Key.resourcesCopySuccess]: "已复制",
	[Key.resourcesTags]: "标签",
	[Key.untitled]: "无标题",
