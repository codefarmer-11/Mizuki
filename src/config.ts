...
export const siteConfig: SiteConfig = {
	...
	siteURL: "https://lysj.work/", // 请替换为你的站点URL，以斜杠结尾
	siteStartDate: "2026-03-30", // 站点开始运行日期，用于站点统计组件计算运行天数
	...
	banner: {
		...
		waves: {
			...
			mobileDisable: true, // 移动端禁用以减轻 GPU 压力
		},
...
export const profileConfig: ProfileConfig = {
	avatar: "", // 相对于 /src 目录。如果以 '/' 开头，则相对于 /public 目录
	name: "Sekiro",
	...
	links: [
		...
		},
		{
			name: "Gitee",
			icon: "mdi:git",
			url: "https://gitee.com/code-farmer-11",
		},
		{
			name: "GitHub",
			icon: "fa7-brands:github",
			url: "https://github.com/codefarmer-11",
		},
		{
			name: "Codeberg",
